...
## Doing
[X] Adjust clap detection logic so Pachi Pachi accurately mirrors user clapping input (via mic)

## Parked / Nice-To-Have
[ ] Can human clapping input = morse code or some kind of simple 'language' that PP uses to reply?
[ ] v2 and beyond ideas go here...